...
class _ProgressPageState extends State<ProgressPage> {
  ...
  List<double?> _englishDailyScores = [
    null,
    null,
    null,
    null,
  ...
  List<double?> _englishClarityScores = [
    null,
    null,
    null,
    null,
  ...
  List<double?> _englishEnergyScores = [
    null,
    null,
    null,
    null,
  ...
  List<double?> _filipinoDailyScores = [
    null,
    null,
    null,
    null,
  ...
  List<double?> _filipinoPaceScores = [
    null,
    null,
    null,
    null,
  ...
  List<double?> _filipinoClarityScores = [
    null,
    null,
    null,
    null,
  ...
  List<double?> _filipinoEnergyScores = [
    null,
    null,
    null,
    null,
  ...
  Future<void> _fetchUserProgress() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final List<dynamic> englishSessions = sessions
  ...
  Map<String, List<double?>> _computeDailyData(
    List<dynamic> sessions,
    ...
    dayScores.forEach((day, scores) {
      ...
      weeklyPace[day] =
          dayPace[day]!.reduce((a, b) => a + b) / dayPace[day]!.length;
      weeklyClarity[day] =
          dayClarity[day]!.reduce((a, b) => a + b) / dayClarity[day]!.length;
      weeklyEnergy[day] =
          dayEnergy[day]!.reduce((a, b) => a + b) / dayEnergy[day]!.length;
    });
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _perfRow(
                            'Pace',
                            _getTrendSubtitle('Pace', skills),
                            (skills[0]['value'] as double),
                            '${skills[0]['score']}%',
                            accentColor,
                          ),
                          ...
                          _perfRow(
                            'Clarity',
                            _getTrendSubtitle('Clarity', skills),
                            (skills[1]['value'] as double),
                            '${skills[1]['score']}%',
                            accentColor,
                          ),
                          const SizedBox(height: 18),
                          _perfRow(
                            'Energy',
                            _getTrendSubtitle('Energy', skills),
                            (skills[2]['value'] as double),
                            '${skills[2]['score']}%',
                            accentColor,
                          ),
                        ],
                  ...
                  children: [
                      ...
                      return Positioned(
                        ...
                        child: Stack(
                          ...
                          children: pts.map((entry) {
                            final x =
                                entry.key * segmentWidth + segmentWidth / 2;
                            final y =
                                chartHeight - (entry.value / 100) * chartHeight;
                            return Positioned(
                              left: x - 6,
                              top: y - 6,
                              child: Container(
                    ...
                    ...List.generate(7, (i) {
                      ...
                      final entries = series
                          ...
                          .map(
                            (m) =>
                                _TooltipEntry(m.label, m.color, m.scores[i]!),
                          )
                          .toList();
                      const tooltipWidth = 130.0;
                      double tooltipLeft =
                          x + segmentWidth / 2 - tooltipWidth / 2;
